				...
				<ul class="navbar-nav iq-main-menu" id="sidebar-menu">
					...
					<li class="nav-item">
						...
						>
							...
							<span class="item-name">Developer</span>
							<i class="right-icon">
								<svg
									class="icon-18"
									xmlns="http://www.w3.org/2000/svg"
						...
						>
							<li class="nav-item">
								<router-link
									:to="{ name: 'DeveloperChat' }"
									class="nav-link"
									:class="{
										active: $route.path === '/developer/chat',
									}"
									aria-current="page"
								>
									<i class="icon">
							...
							<li class="nav-item">
								<router-link
									:to="{ name: 'DeveloperAPISettings' }"
									class="nav-link"
									:class="{
										active: $route.path === '/developer/api/settings',
									}"
									aria-current="page"
								>
									<i class="icon">
									...
									<i class="sidenav-mini-icon"> H </i>
									<span class="item-name"> API Settings </span>
								</router-link>
							</li>
							<li class="nav-item">
								<router-link
									:to="{ name: 'DeveloperThemeSettings' }"
									class="nav-link"
									:class="{
										active: $route.path === '/developer/theme/settings',
									}"
									aria-current="page"
								>
									<i class="icon">
							...
							<li class="nav-item">
								<a class="nav-link" href="@/dashboard/index-dual-compact.html">
									...
									<i class="sidenav-mini-icon"> D </i>
									<span class="item-name">Security Dashboard</span>
								</a>
							</li>
							<li class="nav-item">
								<router-link
									:to="{ name: 'DeveloperLogs' }"
									class="nav-link"
									:class="{ active: $route.path === '/developer/logs' }"
									aria-current="page"
								>
									<i class="icon">
										<svg
									...
									<span class="item-name">Development Logs</span>
								</router-link>
							</li>
						</ul>
					</li>

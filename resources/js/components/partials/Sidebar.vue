                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        >
                            ...
                            <li class="nav-item">
                                <router-link
                                    :to="{ name: 'UserAppRoles' }"
                                    class="nav-link"
                                    :class="{
                                        active:
                                            $route.path === '/user/app/roles',
                                    }"
                                    aria-current="page"
                                >
                                    <i class="icon">
                                    ...
                                    <span class="item-name">System Roles</span>
                                </router-link>
                            </li>
                        </ul>
                    </li>

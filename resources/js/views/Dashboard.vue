<template>
    <div class="conatiner-fluid content-inner mt-n5 py-0">
        <div class="row">
            ...
            <div class="col-lg-3">
                <div>
                    <div v-if="isWalletActive">
                        <Wallet :userWallet="userWallet" />
                    </div>
                    <div v-else>
                        <NoWallet @wallet-connected="handleWalletConnected" />
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-card grid-cols-3">
                            <a
                                ...
                                href="@/assets/images/icons/04.png"
                            >
                                <img
                                    src="@/assets/images/icons/04.png"
                            ...
                            <a
                                data-fslightbox="gallery"
                                href="@/assets/images/shapes/02.png"
                            >
                                <img
                            ...
                            <a
                                data-fslightbox="gallery"
                                href="@/assets/images/icons/08.png"
                            >
                                <img
                            ...
                            <a
                                data-fslightbox="gallery"
                                href="@/assets/images/shapes/04.png"
                            >
                                <img
                            ...
                            <a
                                data-fslightbox="gallery"
                                href="@/assets/images/icons/02.png"
                            >
                                <img
                                    src="@/assets/images/icons/02.png"
                                    class="img-fluid bg-soft-warning rounded"
                                    alt="profile-image"
                                />
                            </a>
                            <a
                                data-fslightbox="gallery"
                                href="@/assets/images/shapes/06.png"
                            >
                                <img
                            ...
                            <a
                                data-fslightbox="gallery"
                                href="@/assets/images/icons/05.png"
                            >
                                <img
                                    src="@/assets/images/icons/05.png"
                                    class="img-fluid bg-soft-danger rounded"
                                    alt="profile-image"
                                />
                            </a>
                            <a
                            ...
                            <a
                                data-fslightbox="gallery"
                                href="@/assets/images/icons/01.png"
                            >
                                <img
                                    src="@/assets/images/icons/01.png"
                                    class="img-fluid bg-soft-success rounded"
                                    alt="profile-image"
                                />
                            </a>
                        </div>
            ...
            <div class="col-lg-6">
                <div class="profile-content tab-content">
                    <div id="profile-feed" class="tab-pane fade active show">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                >
                                    ...
                                    <!-- Other buttons like upload media -->
                                </div>
                                <!-- Comments Section -->
                        ...
                        <div class="card">
                            <div
                                class="card-header d-flex align-items-center justify-content-between pb-4"
                            >
                                <div class="header-title">
                                    <div class="d-flex flex-wrap">
                                        <div
                                            class="media-support-user-img me-3"
                                        >
                                            <img
                                                class="rounded-pill img-fluid avatar-60 bg-soft-danger p-1 ps-2"
                            ...
                            <div class="card-body p-0">
                                <div class="user-post">
                                    <a href="javascript:void(0);"
                                        ><img
                                            src="@/assets/images/pages/02-page.png"
                                            alt="post-image"
                                            class="img-fluid"
                                    /></a>
                                </div>
                                <div class="comment-area p-3">
                                    ...
                                    >
                                        <div class="d-flex align-items-center">
                                            <div
                                                class="d-flex align-items-center message-icon me-3"
                                            >
                                                <svg
                                                    class="icon-20"
                                                    width="20"
                                            ...
                                            <div
                                                class="d-flex align-items-center feather-icon"
                                            >
                                                <svg
                                                    class="icon-20"
                                                    width="20"
                            ...
                            >
                                <div class="header-title">
                                    <div class="d-flex flex-wrap">
                                        ...
                                        >
                                            <img
                                                class="rounded-pill img-fluid avatar-60 p-1 bg-soft-info"
                            ...
                            <div class="card-body">
                                ...
                                >
                                    <ul class="list-inline p-0 m-0">
                                        ...
                                        <li>
                                            <div
                                                class="timeline-dots timeline-dot1 border-success text-success"
                                            ></div>
                                            <h6 class="float-left mb-1">
                                        ...
                                        <li>
                                            <div
                                                class="timeline-dots timeline-dot1 border-danger text-danger"
                                            ></div>
                                            <h6 class="float-left mb-1">
                                                Dev Meetup
                                            </h6>
                                            ...
                                            <div class="d-inline-block w-100">
                                                ...
                                                <div
                                                    class="iq-media-group iq-media-group-1"
                                                >
                                                    <a
                                                        href="#"
                                                        class="iq-media-1"
                                                    >
                                                        <div
                                                            class="icon iq-icon-box-3 rounded-pill"
                                                        >
                                                            SP
                                                        </div>
                                                    </a>
                                        ...
                                        <li>
                                            <div
                                                class="timeline-dots timeline-dot1 border-warning text-warning"
                                            ></div>
                                            <h6 class="float-left mb-1">
                                                Mega event
                                            </h6>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="list-inline m-0 p-0">
                            <li class="d-flex mb-4 align-items-center">
                                <div
                                    class="img-fluid bg-soft-warning rounded-pill"
                                >
                                    <img
                                        src="@/assets/images/icons/05.png"
                                        alt="story-img"
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div
                                    class="img-fluid bg-soft-danger rounded-pill"
                                >
                                    <img
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div
                                    class="img-fluid bg-soft-dark rounded-pill"
                                >
                                    <img
                                        src="@/assets/images/icons/06.png"
                                        alt="story-img"
                                        class="rounded-pill profile-story-img avatar-40"
                                    />
                                </div>
                                <div class="ms-3 flex-grow-1">
                                    <h6>Jenny Wilson</h6>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div
                                    class="img-fluid bg-soft-primary rounded-pill"
                                >
                                    <img
                                        src="@/assets/images/icons/07.png"
                                        alt="story-img"
                                        class="rounded-pill avatar-40"
                                    />
                                </div>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div
                                    class="img-fluid bg-soft-info rounded-pill"
                                >
                                    <img
                                        src="@/assets/images/icons/04.png"
                                        alt="story-img"
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div
                                    class="img-fluid bg-soft-success rounded-pill"
                                >
                                    <img
                                        src="@/assets/images/icons/01.png"
                                        alt="story-img"
...
<script>
import AccountNavbar from "@/components/widgets/AccountNavbar.vue";
import AccountAbout from "@/components/widgets/AccountAbout.vue";
import AccountProfile from "@/components/widgets/AccountProfile.vue";
import AnnouncementListCard from "@/components/widgets/AnnouncementListCard.vue";
import SharedFileListCard from "@/components/widgets/SharedFileListCard.vue";
import Wallet from "@/components/widgets/Wallet.vue";
import NoWallet from "@/components/widgets/NoWallet.vue";
...
export default {
    ...
    setup() {
        ...
        const handleWalletConnected = (publicKey) => {
            // Update the existing userWallet ref, don't redeclare it
            userWallet.value = publicKey;
            isWalletActive.value = true;
        };

        return { isWalletActive, handleWalletConnected, userWallet };
    },
};
</script>

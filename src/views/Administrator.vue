				...
				<div class="row">
					<div class="col-md-12 col-lg-12">
						...
						>
							...
							<div class="card-body">
								<div
									class="flex-wrap mb-4 d-flex align-itmes-center justify-content-between"
								>
								...
								<div class="grid-cols-2 d-grid gap-card">
									...
									<button class="p-2 btn btn-info text-uppercase">
										ANALYTICS
									</button>
								</div>
							</div>

					...
					<div class="card-body">
						<div class="twit-feed">
							<div class="d-flex align-items-center mb-2">
								<img
									class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-soft-danger ps-2"
						...
						<div class="twit-feed">
							<div class="d-flex align-items-center mb-2">
								<img
									class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-soft-primary"
									src="@/assets/images/icons/04.png"
									alt=""
								/>
								<div class="media-support-info">
						...
						<div class="twit-feed">
							<div class="d-flex align-items-center mb-2">
								<img
									class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-soft-warning pt-2"
									src="@/assets/images/icons/02.png"
									alt=""
								/>
								<div class="mt-2">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="mt-2">
									...
									<p>
										<a href="#" class="text-body" target="_blank">
											www.bootstrap.com
										</a>
									</p>
								</div>
								<div class="mt-2">
									...
									<p>
										<a href="#" class="text-body">(001) 4544 565 456</a>
									</p>
								</div>
							</div>
						</div>
			...
			<div class="col-lg-3">
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="mb-1">
							Email: <a href="#" class="ms-3">nikjone@demoo.com</a>
						</div>
						<div class="mb-1">
							Phone: <a href="#" class="ms-3">001 2351 256 12</a>
						</div>
...
<script>
import AccountNavbar from "@/components/widgets/AccountNavbar";
...
export default {
	...
	setup() {
		...
		const _userWallet = ref(null);

		const handleWalletConnected = (publicKey) => {
			// Update the existing _userWallet ref, don't redeclare it
			_userWallet.value = publicKey;
			isWalletActive.value = true;
		};

		return { isWalletActive, handleWalletConnected, _userWallet };
	},
};
</script>
